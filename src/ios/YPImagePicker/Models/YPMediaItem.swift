...
public class YPMediaPhoto {
    ...
    init(image: UIImage, exifMeta : [String : Any]? = nil, fromCamera: Bool = false, asset: PHAsset? = nil, cropRect: CGRect?, zoomScale: CGFloat?, contentOffset: CGPoint?) {
...
public class YPMediaVideo {
    ...
    init(thumbnail: UIImage, videoURL: URL, fromCamera: Bool = false, asset: PHAsset? = nil, cropRect: CGRect?, zoomScale: CGFloat?, contentOffset: CGPoint?) {
