...
final class YPLibraryView: UIView {
    ...
    func setupMaxNumberOfItemsView() {
        ...
        // Style
        maxNumberWarningView.backgroundColor = UIColor(r: 66, g: 66, b: 66)
        maxNumberWarningLabel.font = UIFont(name: "Helvetica Neue", size: 20)
        maxNumberWarningLabel.textColor = .white
