...
public class YPPickerVC: YPBottomPager, YPBottomPagerDelegate {
    ...
    public override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(r: 66, g: 66, b: 66)
        self.navigationController?.navigationBar.barTintColor = UIColor(r: 66, g: 66, b: 66)
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedStringKey.foregroundColor: UIColor.white, NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 30)]
        ...
        if YPConfig.screens.contains(.photo) {
            ...
            cameraVC?.didCapturePhoto = { [weak self] img in
                self?.didSelectItems?([YPMediaItem.photo(p: YPMediaPhoto(image: img,
                                                                        fromCamera: true, cropRect: nil, zoomScale: nil, contentOffset: nil))])
            }
        }
    ...
    public override func viewDidAppear(_ animated: Bool) {
        ...
        if let v = navigationItem.rightBarButtonItem?.customView {
            v.layer.cornerRadius = 0.05 * v.bounds.size.width
    ...
    func updateUI() {
        ...
        navigationItem.leftBarButtonItem?.setTitleTextAttributes([NSAttributedStringKey.font: UIFont.systemFont(ofSize: 28)], for: .normal)
        
        switch mode {
        case .library:
            setTitleViewWithTitle(aTitle: libraryVC?.title ?? "")
//            let doneBtn = UIButton(type: .custom)
//            doneBtn.setTitle(YPConfig.wordings.done, for: .normal)
//            doneBtn.setTitleColor(.white, for: .normal)
//            doneBtn.titleLabel?.font = UIFont.boldSystemFont(ofSize: 20)
//            doneBtn.setBackgroundColor(UIColor(r: 33, g: 186, b: 69), forState: .normal)
...
//            navigationItem.rightBarButtonItem = UIBarButtonItem(customView: doneBtn)
            ...
            navigationItem.rightBarButtonItem?.tintColor = UIColor(r: 33, g: 186, b: 69)
            navigationItem.rightBarButtonItem?.setTitleTextAttributes([NSAttributedStringKey.font: UIFont.systemFont(ofSize: 28)], for: .normal)
...
extension YPPickerVC: YPLibraryViewDelegate {
    ...
    public func libraryViewStartedLoading() {
        ...
        DispatchQueue.main.async {
            self.v._scrollView.isScrollEnabled = false
    ...
    public func libraryViewFinishedLoading() {
        ...
        DispatchQueue.main.async {
            self.v._scrollView.isScrollEnabled = YPConfig.isScrollToChangeModesEnabled
