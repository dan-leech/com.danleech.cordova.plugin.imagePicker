...
import com.danleech.cordova.plugin.imagePicker.features.ImagePickerSavePath;
...
public class ImagePickerUtils {
    ...
    public static File createVideoFile(ImagePickerSavePath savePath) {
        ...
        File mediaStorageDir = savePath.isFullPath()
                ? new File(path)
                : new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES), path);
